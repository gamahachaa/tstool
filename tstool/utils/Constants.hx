...
class Constants 
{
	public static inline var SIMPLE_CR:String = "\n";
	public static inline var DOUBLE_CR:String = "\n\n";
	...
	//public static inline var FIBER_WINBACK_BANK_HOLIDAYS_STRING:String = "2022-08-01,2022-12-25,2022-12-26,2023-01-01,2023-01-02,2023-04-07,2023-04-10,2023-05-18,2023-05-29,2023-08-01,2023-12-25,2023-12-26,2024-01-01,2024-01-02"; //monday friday
	#if debug
	//public static var FIBER_WINBACK_BANK_HOLIDAYS:Array<String> = ["2022-08-01","2022-12-12","2022-12-26","2023-01-01","2023-01-02","2023-04-07","2023-04-10","2023-05-18","2023-05-29","2023-08-01","2023-12-25","2023-12-26","2024-01-01","2024-01-02"];
	#else
	//public static var FIBER_WINBACK_BANK_HOLIDAYS:Array<String> = [
	//"2022-08-01", 
	//"2022-12-24", 
	//"2022-12-25", 
	//"2022-12-26", 
	...
	public static inline var SERVICE:String = "SERVICE";
	/**
	 * AGENT
	 */
	static public inline var JUSTIFICATION:String = "justification";
